...
void load_hiddenTab(Graph* head,char* url);
...
void my_moveTab(int fromIndex, int toIndex);
    QUrl get_preurl(int i){return pre_url[i];}
    void set_preurl(int i,char *url){ pre_url[i] = url;}
protected:
