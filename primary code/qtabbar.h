...
/////////////////////////////////intelligent browser start
    int get_HiddenIndex();//not used
	void set_tabHidden(int index, bool hide);//not used
...
/////////////////////////////////////intelligent browser start
    void tabHide(int index, int to);//set the tab hidden, don't care "to"
    void tabShow(int index);//set hidden flag to false
/////////////////////////////////////intelligent browser end
Q_SIGNALS:
