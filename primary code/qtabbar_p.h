...
public:
    QTabBarPrivate()
        ...
        switchTabCurrentIndex(-1), switchTabTimerId(0), movingTab(0), hiddenIndex(-1)//hiddenIndex -> not used
#ifdef Q_WS_MAC
    ...
    int scrollOffset;
//////////////////////////////////////////////////////////////
	int hiddenIndex;//not used
    void setHiddenIndex(int index){hiddenIndex=index;}//not used
    int getHiddenIndex(){return hiddenIndex;}//not uesed
//////////////////////////////////////////////////////////////
    struct Tab {
        inline Tab(const QIcon &ico, const QString &txt)
            : enabled(true) , shortcutId(0), text(txt), icon(ico),
            leftWidget(0), rightWidget(0), lastTab(-1), dragOffset(0), hidden(false)//hidden flag init to false in intelligent browser
...
///////////////////////////////////////////intelligent browser start
	bool hidden;//hidden flag of tab
